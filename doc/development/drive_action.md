...
- [The drive job](#the-drive-job)
  ...
  - [10. Comment result in pull request `actions/github-script@v8`](#10-comment-result-in-pull-request-actionsgithub-scriptv8)
...
Same step as in the [build job](build_action.md#1-checkout-repository-actionscheckoutv5)
...
### 10. Comment result in pull request [`actions/github-script@v8`](https://github.com/marketplace/actions/github-script)
