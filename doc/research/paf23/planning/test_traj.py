...
wp = wp = np.r_[
    [np.full((50), 983.5889666959667)],
    [np.linspace(5370.016106881272, 5399.016106881272, 50)],
].T
initial_conditions = {
    "ps": 0,
    "target_speed": 6,
    ...
    "wp": wp,
    "obs": np.array(
        [[983.568124548765, 5386.0219828457075, 983.628124548765, 5386.0219828457075]]
    ),
}
...
(
    ...
    costs,
    success,
) = run_fot(initial_conditions, hyperparameters)
...
if success:
    ...
    ax[0].scatter(
        [983.568124548765, 983.628124548765],
        [5386.0219828457075, 5386.0219828457075],
        label="object",
    )
