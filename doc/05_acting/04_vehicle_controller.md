...
![Braking Comparison](/doc/00_assets/acting/emergency_brake_stats_graph.png)
...
This is done to drive in a specific way whenever we get into a stuck situation and the [Unstuck Behavior](/doc/07_planning/Behavior_detailed.md) is persued.
