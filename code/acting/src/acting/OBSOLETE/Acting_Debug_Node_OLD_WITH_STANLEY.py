...
TARGET_VELOCITY_1: float = 15  # velocity 1
TARGET_VELOCITY_2: float = 0  # velocity 2

STEERING_CONTROLLER_USED = 1  # 0 = both ; 1 = PP ; 2 = Stanley
# 0 = Straight ; 1 = Curve ; 2 = SineWave ; 3 = Overtake
TRAJECTORY_TYPE = 1

PRINT_AFTER_TIME = 15.0  # How long after Simulationstart to print data
