...
from .panoptic_segmentation_module import \
...
class EfficientPS(pl.LightningModule):
    ...
    def shared_step(self, inputs):
        ...
        semantic_logits, semantic_loss = self.semantic_head(pyramid_features,
                                                            inputs)
        pred_instance, instance_losses = self.instance_head(pyramid_features,
                                                            inputs)
        # Output set up
