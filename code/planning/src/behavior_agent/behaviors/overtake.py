    ...
    def update(self):
        ...
        if (
            ...
            entity = map.get_obstacle_on_trajectory(
                collision_trajectory, hero_pos, hero_heading, 1.4
            )
        else:
            rospy.loginfo(
        ...
        if entity is not None:
            obstacle_distance = math.dist(
                [0, 0], entity.transform.translation().point()._matrix.tolist()[:2]
            )
